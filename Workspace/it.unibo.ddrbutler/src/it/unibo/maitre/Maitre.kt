		...
		return { //this:ActionBasciFsm
				...
				state("waitingPrepCompletion") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t014",targetState="sendingAC",cond=whenDispatch("prepareCompleted"))
				...
				state("waitingAddFoodCompletion") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t018",targetState="sendingAC",cond=whenDispatch("addFoodCompleted"))
