		...
		return { //this:ActionBasciFsm
				...
				state("waitCmd") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t061",targetState="puttingElement",cond=whenDispatch("putElement"))
					transition(edgeName="t062",targetState="takingElement",cond=whenDispatch("takeElement"))
				}	 
