		...
		return { //this:ActionBasciFsm
				...
				state("waitCmd") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t051",targetState="puttingDish",cond=whenDispatch("dishwasherPutDish"))
					transition(edgeName="t052",targetState="takingDish",cond=whenDispatch("dishwasherTakeDish"))
				}	 
