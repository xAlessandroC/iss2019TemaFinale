		...
		return { //this:ActionBasciFsm
				...
				state("waitCmd") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t0100",targetState="putDish",cond=whenDispatch("putDishPantry"))
					transition(edgeName="t0101",targetState="takeDish",cond=whenDispatch("takeDishPantry"))
				}	 
