...
class Stuffontable ( name: String, scope: CoroutineScope ) : ActorBasicFsm( name, scope){
		...
		return { //this:ActionBasciFsm
				...
				state("gettingContent") { //this:State
					action { //it:State
						...
						if(currentSolution.isSuccess()) { var response = getCurSol("L").toString().replace("[","").replace("]","")
