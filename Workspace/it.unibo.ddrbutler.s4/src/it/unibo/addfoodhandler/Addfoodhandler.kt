		...
		return { //this:ActionBasciFsm
				...
				state("waitingCmd") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t083",targetState="askingFood",cond=whenDispatch("startAddFood"))
				}	 
				state("askingFood") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t084",targetState="analyzeResponse",cond=whenDispatch("responseFood"))
				}	 
				...
				state("planF") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t085",targetState="takingFood",cond=whenDispatch("planningCompleted"))
				}	 
				...
				state("planT") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t086",targetState="puttingFood",cond=whenDispatch("planningCompleted"))
				}	 
				...
				state("planRH") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t087",targetState="endAddFood",cond=whenDispatch("planningCompleted"))
				}	 
