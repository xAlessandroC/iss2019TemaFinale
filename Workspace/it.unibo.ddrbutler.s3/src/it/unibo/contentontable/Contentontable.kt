		...
		return { //this:ActionBasciFsm
				...
				state("waitingCmd") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t078",targetState="gettingContent",cond=whenDispatch("getContent"))
					transition(edgeName="t079",targetState="settingContent",cond=whenEvent("updateContent"))
				}	 
