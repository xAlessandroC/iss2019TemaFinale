		...
		return { //this:ActionBasciFsm
				...
				state("waitCmd") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t080",targetState="putDish",cond=whenDispatch("putDishDishwasher"))
					transition(edgeName="t081",targetState="takeDish",cond=whenDispatch("takeDishDishwasher"))
				}	 
