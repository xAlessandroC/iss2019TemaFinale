		...
		return { //this:ActionBasciFsm
				...
				state("waitCmd") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t055",targetState="calculatePath",cond=whenDispatch("goto"))
					transition(edgeName="t056",targetState="updateRoomDescription",cond=whenDispatch("setLocation"))
				}	 
				...
				state("schedulingNextMove") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t057",targetState="waitCmd",cond=whenDispatchGuarded("schedulingCompleted",{finito}))
					transition(edgeName="t058",targetState="execMove",cond=whenDispatchGuarded("schedulingCompleted",{!finito}))
				}	 
				state("execMove") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t059",targetState="schedulingNextMove",cond=whenDispatch("moveCompleted"))
				}	 
			}
		}
}
