		...
		return { //this:ActionBasciFsm
				...
				state("waitCmd") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t028",targetState="answering",cond=whenDispatch("query"))
					transition(edgeName="t029",targetState="puttingFood",cond=whenDispatch("putFood"))
					transition(edgeName="t030",targetState="takingFood",cond=whenDispatch("takeFood"))
					transition(edgeName="t031",targetState="gettingContent",cond=whenDispatch("get"))
				}	 
