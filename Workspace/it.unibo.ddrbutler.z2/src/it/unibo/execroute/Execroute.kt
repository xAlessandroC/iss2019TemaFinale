		...
		return { //this:ActionBasciFsm
				...
				state("suspendedScheduling") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t025",targetState="suspendedScheduling",cond=whenDispatch("stop"))
					transition(edgeName="t026",targetState="scheduling",cond=whenDispatch("reactivate"))
				}	 
			}
		}
}
