		...
		return { //this:ActionBasciFsm
				...
				state("waitCmd") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t032",targetState="puttingDish",cond=whenDispatch("pantryPutDish"))
					transition(edgeName="t033",targetState="takingDish",cond=whenDispatch("pantryTakeDish"))
				}	 
