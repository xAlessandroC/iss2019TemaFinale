		...
		return { //this:ActionBasciFsm
				...
				state("waitCmd") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t021",targetState="initAi",cond=whenDispatch("startCalibration"))
				}	 
				...
				state("forwardStep") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t022",targetState="confirmForwardStep",cond=whenDispatch("moveCompleted"))
					transition(edgeName="t023",targetState="backtracking",cond=whenDispatch("moveFailed"))
					transition(edgeName="t024",targetState="terminazioneboundary",cond=whenDispatch("endBoundary"))
				}	 
				...
				state("backtracking") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t025",targetState="turnLeft",cond=whenDispatch("moveCompleted"))
				}	 
				state("turnLeft") { //this:State
					action { //it:State
						itunibo.planner.moveUtils.rotateLeft90tuning(myself)
					}
					 transition(edgeName="t026",targetState="forwardStep",cond=whenDispatch("moveCompleted"))
				}	 
				...
				state("snakeForwardStep") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t027",targetState="snakeTurnLeft",cond=whenDispatchGuarded("moveCompleted",{nextDir.equals("left")}))
					transition(edgeName="t028",targetState="snakeTurnRight",cond=whenDispatchGuarded("moveCompleted",{nextDir.equals("right")}))
				}	 
				state("snakeTurnLeft") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t029",targetState="snakeForwardStep",cond=whenDispatchGuarded("moveCompleted",{nextDir.equals("forward")}))
					transition(edgeName="t030",targetState="snakeGoAhead",cond=whenDispatchGuarded("moveCompleted",{nextDir.equals("goAhead")}))
				}	 
				state("snakeTurnRight") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t031",targetState="snakeForwardStep",cond=whenDispatchGuarded("moveCompleted",{nextDir.equals("forward")}))
					transition(edgeName="t032",targetState="snakeGoAhead",cond=whenDispatchGuarded("moveCompleted",{nextDir.equals("goAhead")}))
				}	 
				state("snakeGoAhead") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t033",targetState="endExploration",cond=whenDispatchGuarded("moveCompleted",{nextDir.equals("completed")}))
					transition(edgeName="t034",targetState="snakeTurnLeft",cond=whenDispatchGuarded("moveCompleted",{nextDir.equals("left")}))
					transition(edgeName="t035",targetState="snakeTurnRight",cond=whenDispatchGuarded("moveCompleted",{nextDir.equals("right")}))
					transition(edgeName="t036",targetState="snakeGoAhead",cond=whenDispatchGuarded("moveCompleted",{nextDir.equals("straight")}))
					transition(edgeName="t037",targetState="findTable",cond=whenDispatch("moveFailed"))
				}	 
				...
				state("goSouthFT") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t039",targetState="forwardStepFT",cond=whenDispatch("moveCompleted"))
				}	 
				state("forwardStepFT") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t040",targetState="goIntern",cond=whenDispatch("moveCompleted"))
				}	 
				state("goIntern") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t041",targetState="checkTable",cond=whenDispatch("moveCompleted"))
				}	 
				state("checkTable") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t042",targetState="confirmForwardStepFT",cond=whenDispatch("moveCompleted"))
					transition(edgeName="t043",targetState="backtrackingFT",cond=whenDispatch("moveFailed"))
				}	 
				state("backtrackingFT") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t044",targetState="goSouthFT",cond=whenDispatch("moveCompleted"))
				}	 
				...
				state("goHome") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t045",targetState="waitCmd",cond=whenDispatch("planningCompleted"))
				}	 
			}
		}
}
