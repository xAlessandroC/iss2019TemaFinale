		...
		return { //this:ActionBasciFsm
				...
				state("waitCmd") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t029",targetState="answering",cond=whenDispatch("query"))
					transition(edgeName="t030",targetState="puttingFood",cond=whenDispatch("putFood"))
					transition(edgeName="t031",targetState="takingFood",cond=whenDispatch("takeFood"))
					transition(edgeName="t032",targetState="gettingContent",cond=whenDispatch("get"))
				}	 
