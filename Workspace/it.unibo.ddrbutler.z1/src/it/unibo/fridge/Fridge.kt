		...
		return { //this:ActionBasciFsm
				...
				state("waitCmd") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t047",targetState="answering",cond=whenDispatch("query"))
					transition(edgeName="t048",targetState="puttingFood",cond=whenDispatch("putFood"))
					transition(edgeName="t049",targetState="takingFood",cond=whenDispatch("takeFood"))
				}	 
