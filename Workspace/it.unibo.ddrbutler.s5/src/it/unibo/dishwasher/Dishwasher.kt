		...
		return { //this:ActionBasciFsm
				...
				state("waitCmd") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t097",targetState="putDish",cond=whenDispatch("putDishDishwasher"))
					transition(edgeName="t098",targetState="takeDish",cond=whenDispatch("takeDishDishwasher"))
				}	 
